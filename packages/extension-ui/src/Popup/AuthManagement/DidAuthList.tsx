...
import DidWebsiteEntry from './DidWebsiteEntry.js';

interface Props extends ThemeProps {
  className?: string;
}

function DidAuthList ({ className }: Props): React.ReactElement<Props> {
  ...
  return (
    <>
      <Header
        showBackArrow
        smallMargin
        text={t<string>('Manage DID Access')}
      />
...
export default styled(DidAuthList)`
