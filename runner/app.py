...
common.config.init_node_dir(params.args.node_dir)
# common.config.init_config(args.config_file)
common.config.init_config(path.join(common.config.node_dir, "config.json"))
# common.file.initialise_file_managers(args.config_file)
common.file.initialise_file_managers(common.config.node_dir)
...
substrate_args = [path.join(ROOT_DIR, "target/release/qmc-node"),
                  ...
                  f"--base-path={path.join(common.config.node_dir, 'node')}",
