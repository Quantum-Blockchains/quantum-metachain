...
params.args.startup_args.append(common.config.config_service.config.abs_psk_file_path())
...
params.args.startup_args.append(common.config.config_service.config.abs_node_key_file_path())
